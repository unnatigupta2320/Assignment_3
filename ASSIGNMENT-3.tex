...
\\
\vec{n}=\myvec{\frac{r\textsubscript{n}^2}{M\textsubscript{1}}\\0}
\\
...
\begin{align}
    \implies  \myvec{M\textsubscript{1}&0}\vec{N} &=r\textsubscript{n}^2 
    \\
    \implies   \myvec{1&0}\vec{N} &=\myvec{\frac{r\textsubscript{n}^2}{M\textsubscript{1}}\\0} 
    \\
    \implies \vec{N}&=\myvec{\frac{r\textsubscript{n}^2}{M\textsubscript{1}}\\0} +\lambda\myvec{0\\1}
  \\
    \implies \vec{N}&=\vec{n}+\lambda\vec{m} 
   \end{align}
    \begin{align}
   \text{where, }\vec{n}&=\myvec{\frac{r\textsubscript{n}^2}{M\textsubscript{1}}\\0} \text{and }\vec{m}=\myvec{0\\1}
   \end{align}
\item Also we know,
\begin{align}
...
where,
\begin{align}
 \vec{m}=\myvec{0\\1},\vec{p}=\myvec{\frac{r\textsubscript{1}}{M\textsubscript{1}}\\0}
 \end{align}
 \item Using $\vec{B}=\myvec{M\textsubscript{1}\\0}=\myvec{8\\0}$, we get: 
 \begin{align}
...
where,
\begin{align}
 \vec{m}=\myvec{0\\1},\vec{s}=\myvec{\frac{d\textsubscript{2}}{M\textsubscript{1}}\\0}
 \end{align}
 \item Using \eqref{eqX} and $\vec{B}=\myvec{M\textsubscript{1}\\0}=\myvec{8\\0}$ we get :
 \begin{align}
