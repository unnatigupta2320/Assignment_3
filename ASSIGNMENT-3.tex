...
\\
\vec{n}=\myvec{\frac{r\textsubscript{n}^2}{\vec{M}}\\0}
\\
...
\begin{align}
    \implies  \myvec{M&0}\vec{N} &=r\textsubscript{n}^2 
    \\
    \implies   \myvec{1&0}\vec{N} &=\myvec{\frac{r\textsubscript{n}^2}{M}\\0} 
    \\
    \implies \vec{N}&=\myvec{\frac{r\textsubscript{n}^2}{M}\\0} +\lambda\myvec{0\\1}
  \\
    \implies \vec{N}&=\vec{n}+\lambda\vec{m} 
   \end{align}
    \begin{align}
   \text{where, }\vec{n}&=\myvec{\frac{r\textsubscript{n}^2}{M}\\0} \text{and }\vec{m}=\myvec{0\\1}
   \end{align}
\item Also we know,
\begin{align}
...
where,
\begin{align}
 \vec{m}=\myvec{0\\1},\vec{p}=\myvec{\frac{r\textsubscript{1}^2}{M}\\0}
 \end{align}
 \item Using $\vec{B}=\myvec{8\\0}$, we get: 
 \begin{align}
 \vec{p}=\myvec{\frac{16}{8}\\0}=\myvec{2\\0}
\end{align}
And
\begin{align}
\lambda\textsubscript{1} &= \pm\sqrt{\frac{r\textsubscript{1}^2-\norm{\vec{p}}^2}{\norm{\vec{m}}^2}}
\\
...
\begin{itemize}
\item Here,we have r\textsubscript{2}=3. If d\textsubscript{CO} = distance of centre of circle from origin.
\item Then \textbf{d\textsubscript{2}} is given by,
\begin{align}
...
where,
\begin{align}
 \vec{m}=\myvec{0\\1},\vec{s}=\myvec{\frac{d\textsubscript{2}}{M}\\0}
 \end{align}
 \item Using \eqref{eqX} and $\vec{B}=\myvec{8\\0}$ we get :
 \begin{align}
