...
where,
\begin{align}
 \vec{m}=\myvec{0\\1},\vec{r}=\myvec{\frac{\norm{\vec{R}}^2}{x\textsubscript{1}}\\0}
 \end{align}
 \item As $\vec{B}=\myvec{x\textsubscript{1}\\0}=\myvec{8\\0}$ and  from \eqref{eqc} $\norm{\vec{R}}^2$=55, we get 
 \begin{align}
