...
\item Referencing \eqref{eq2},we have
\begin{align}
 \vec{R}=\vec{r}+\lambda \vec{m}   \label{eqb}
\end{align}
where,
\begin{align}
 \vec{m}=\myvec{0\\1},\vec{r}=\myvec{\frac{d\textsubscript{n2}^2}{x\textsubscript{1}}\\0}
 \end{align}
 \item Using \eqref{eqc} and $\vec{B}=\myvec{x\textsubscript{1}\\0}=\myvec{8\\0}$ we get :
 \begin{align}
 \vec{r}=\myvec{\frac{55}{8}\\0}=\myvec{6.875\\0}
\end{align}
And
\begin{align}
\lambda &= \pm\sqrt{\frac{\norm{d\textsubscript{n2}}^2-\norm{\vec{r}}^2}{\norm{\vec{m}}^2}}
\\
\lambda &= \pm\sqrt{55-47.265}
\\
\lambda &= \pm\sqrt{7.735}=\pm 2.78
\end{align}
\end{itemize}
\item Substituting $\lambda$, $\vec{r}$ and $\vec{m}$ in \eqref{eqb} we get the coordinates of $\vec{R}$ and  $\vec{S}$ as :
\begin{align}
